  ...
  const resources = [
    {
      ...
      description: "Learn the basics of DSA with interactive examples and practice problems.",
      level: "beginner",
      type: "video",
      duration: "45 min",
      url: "#",
    ...
    },
    {
      ...
      description: "Master complex graph algorithms including shortest path and minimum spanning tree.",
      level: "advanced",
      type: "article",
      duration: "30 min read",
      url: "#",
      downloadUrl: "#",
      tags: ["Graphs", "Algorithms", "Competition"]
    },
    {
      id: 3,
      title: "Dynamic Programming Patterns",
      description: "Comprehensive guide to DP patterns with solved examples and practice problems.",
      level: "intermediate",
      type: "video",
      duration: "1h 20min",
      url: "#",
    ...
    },
    {
      ...
      description: "Build modern web applications using React, TypeScript, and modern tools.",
      level: "intermediate",
      type: "course",
      duration: "3h 45min",
      url: "#",
    ...
    },
    {
      ...
      description: "Complete guide to competitive programming with strategies and techniques.",
      level: "beginner",
      type: "ebook",
      duration: "200 pages",
      url: "#",
      downloadUrl: "#",
      tags: ["CP", "Contests", "Strategies"]
    },
    {
      id: 6,
      title: "Machine Learning Fundamentals",
      description: "Introduction to ML concepts with Python implementations and real-world examples.",
      level: "intermediate",
      type: "course",
      duration: "2h 30min",
      url: "#",
          ...
          {filteredResources.map((resource, index) => (
            <Card key={resource.id} className="glass-card p-6 hover:glow-effect transition-all duration-500 group relative overflow-hidden animate-fade-in" style={{animationDelay: `${index * 0.1}s`}}>
              ...
              <div className="absolute top-0 right-0 w-20 h-20 opacity-5 group-hover:opacity-10 transition-opacity">
                <div className="text-4xl font-mono text-primary">{resource.type === 'video' ? '▶' : resource.type === 'course' ? '📖' : '📄'}</div>
              </div>
