  ...
  return (
    <div className="min-h-screen pt-20 px-4">
      <div className="max-w-7xl mx-auto">
        ...
        {/* Recent Highlights */}
        <div className="mt-16">
          <h2 className="text-3xl font-bold text-gradient text-center mb-8">Recent Highlights</h2>
          <div className="grid md:grid-cols-3 gap-8">
            <Card className="glass-card p-6 text-center">
              <div className="text-4xl mb-4">🥇</div>
              <h3 className="text-xl font-semibold mb-2">National Recognition</h3>
              <p className="text-muted-foreground text-sm">
                Dotslash received recognition as one of the top coding clubs in Maharashtra.
              </p>
            </Card>
            <Card className="glass-card p-6 text-center">
              <div className="text-4xl mb-4">🎓</div>
              ...
              <p className="text-muted-foreground text-sm">
                All our core team members secured excellent placements in top tech companies.
              </p>
            </Card>
            <Card className="glass-card p-6 text-center">
              <div className="text-4xl mb-4">🌟</div>
              ...
              <p className="text-muted-foreground text-sm">
                Reached 1000+ students through our workshops and events this year.
              </p>
            </Card>
          </div>
        </div>
